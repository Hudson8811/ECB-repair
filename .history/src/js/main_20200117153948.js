...
function toggleHeader() {
  ...
  if (scroll_status > 70 && (!$("#header").hasClass("header_min"))) {
    ...
    setTimeout(function () { $("#header").addClass("header_min"); }, 200);
...
var swiper = new Swiper('.swiper-container:not(.swiper-container-2)', {
  navigation: {
